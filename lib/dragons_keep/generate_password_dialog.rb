...
module DragonsKeep
  class GeneratePasswordDialog < Wx::Dialog
    ...
    def initialize
      ...
      @use_special_chars = Wx::CheckBox.new self, ID_SPECIAL, "Use special Characters"
      grid_sizer.add @use_special_chars, 1 , Wx::EXPAND
      @length_password = Wx::SpinCtrl.new self, ID_SIZE, :value=>"8"
      grid_sizer.add StaticText.new(self, :label=>"Length of Password:"), 0, Wx::ALL |Wx::ALIGN_RIGHT
